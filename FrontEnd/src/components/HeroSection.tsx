export function HeroSection(){
    return (
        <section className="relative min-h-screen md:min-h-[85vh] bg-black flex flex-col items-center justify-start pt-20 md:pt-32 pb-40 overflow-hidden">
            ...
            <div className="relative w-full flex-grow flex items-center justify-center mt-[-20px] md:mt-[-40px]">
                <img
