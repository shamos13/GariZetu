...
export default function AboutPage() {
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* Hero Section */}
            <section className="relative bg-black pt-28 pb-14 overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto px-5 md:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-5 -left-5 bg-black text-white p-4 rounded-2xl shadow-xl">
                ...
                <div className="max-w-6xl mx-auto px-5 md:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {VALUES.map((value) => (
                            <div 
                                key={value.title}
                                className="bg-white rounded-2xl p-5 border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all"
                            >
            ...
            <section className="py-12 md:py-14 bg-black text-white">
                <div className="max-w-6xl mx-auto px-5 md:px-8">
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                        <Link 
                            to="/vehicles"
                            className="px-7 py-3 bg-white text-black rounded-xl font-semibold hover:bg-gray-100 transition-colors"
                        >
                            Browse Our Fleet
                        </Link>
                        <Link 
                            to="/contact"
                            className="px-7 py-3 border border-white/30 text-white rounded-xl font-semibold hover:bg-white/10 transition-colors"
                        >
                            Contact Us
                        </Link>
                    </div>
            ...
            <section className="py-12 bg-emerald-600">
                <div className="max-w-4xl mx-auto px-5 md:px-8 text-center">
                    ...
                    <Link 
                        to="/vehicles"
                        className="inline-block px-7 py-3 bg-white text-emerald-600 rounded-xl font-bold hover:bg-gray-100 transition-colors"
                    >
                        Start Your Journey
                    </Link>
                </div>
